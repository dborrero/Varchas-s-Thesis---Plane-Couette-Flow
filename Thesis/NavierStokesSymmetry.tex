...
Dynamical systems in physics often display symmetry. Understanding these symmetry properties can be very useful to physicists, since they can be exploited to significantly simplify the system. Before we further discuss symmetry, however, it will be useful to introduce some terminology, following the conventions in\rf{Rotman1995}.  \\
